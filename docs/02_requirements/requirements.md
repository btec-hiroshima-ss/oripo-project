...
#### 💡 プライバシー方針
近年のプライバシーポリシーに配慮し、業務上必要最低限の個人情報のみ保持する設計とする。AIPO にある個人情報項目（電話番号・メールアドレス等）でも、Oripo では保持しないものがある。
...
| ロール | 権限 |
|---|---|
| 管理者 | 通常業務機能 + システム管理（ユーザー・部署・役職・設備・権限の管理） |
...
- デバイス: PC（必須）、スマートフォン（レスポンシブ対応、詳細は 2.9 参照）
